...
import com.sudokuhelper.game.Cell;
import com.sudokuhelper.game.CellCollection;
import com.sudokuhelper.game.CellCollection.OnChangeListener;
import com.sudokuhelper.game.CellNote;
...
public class SudokuBoardView extends View {
	...
	public SudokuBoardView(Context context, AttributeSet attrs/*, int defStyle*/) {
        ...
        setBackgroundColorReadOnly(a.getColor(R.styleable.SudokuBoardView_backgroundColorReadOnly, Color.GRAY));//modified by xie fei 
...
//        Log.d(TAG, "heightSize=" + heightSize);
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mCells != null) {
			...
			//boolean hasBackgroundColorReadOnly = true;
